...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { bike_id: @bike.bike_id, description: @bike.description, name: @bike.name, price: @bike.price, user_id: @bike.user_id }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { bike_id: @bike.bike_id, description: @bike.description, name: @bike.name, price: @bike.price, user_id: @bike.user_id }
    assert_redirected_to bike_path(assigns(:bike))
  end
